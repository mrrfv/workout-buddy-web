...
export default function Landing() {
    return (
        <>
            <section className="flex min-h-screen lg:flex-row flex-col items-center justify-center font-sans bg-gray-200 dark:bg-gray-900">
                ...
                <div>
                    ...
                    <p className="text-lg text-center max-w-xl mb-4 px-4">Workout Buddy analyzes workout videos on your screen with private vision language models (AI) to help you stay on track by analyzing your screen and providing timely notifications.</p>
